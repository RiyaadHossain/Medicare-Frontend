      ...
      <section>
        <div className="container">
          <SectionHeader
            ...
            desc=" World-class care for everyone. Our health System offers unmatched,
              expert health care."
          />
        ...
        <div className="container">
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
              ...
              <div className="w-[150px] border lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
